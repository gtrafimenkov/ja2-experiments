...
BOOLEAN InitMainMenu() {
  ...
  CHECKF(AddStandardVideoObject(&VObjectDesc, &guiMainMenuBackGroundImage));
  ...
  CHECKF(AddStandardVideoObject(&VObjectDesc, &guiJa2LogoImage));
...
void RenderMainMenu() {
  ...
  BltVideoObject(vsSB, hPixHandle, 0, 0, 0, VO_BLT_SRCTRANSPARENCY, NULL);
  ...
  BltVideoObject(vsSB, hPixHandle, 0, 188, 15, VO_BLT_SRCTRANSPARENCY, NULL);
