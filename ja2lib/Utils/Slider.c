...
void RenderSliderBox(SLIDER *pSlider) {
  ...
  if (pSlider->uiFlags & SLIDER_VERTICAL) {
    ...
    if (!(pSlider->LastRect.iLeft == 0 && pSlider->LastRect.iRight == 0)) {
      ...
      BlitBufferToBuffer(vsSaveBufferID, vsIndexFB, (uint16_t)pSlider->LastRect.iLeft,
    ...
    // Blit the new rect
    BlitBufferToBuffer(vsIndexFB, vsSaveBufferID, (uint16_t)DestRect.iLeft, (uint16_t)DestRect.iTop,
  ...
  if (pSlider->uiFlags & SLIDER_VERTICAL) {
    ...
    BltVideoObjectOld(vsIndexFB, hPixHandle, 0, pSlider->LastRect.iLeft, pSlider->LastRect.iTop);
    ...
    // display the slider box
    GetVideoObject(&hPixHandle, guiSliderBoxImage);
    BltVideoObjectOld(vsIndexFB, hPixHandle, 0, pSlider->usCurrentSliderBoxPosition,
