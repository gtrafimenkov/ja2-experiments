...
void SetFontForeground(uint8_t ubForeground) {
  ...
  FontForeground16 = rgb32_to_rgb16(FROMRGB(uiRed, uiGreen, uiBlue));
}
...
void SetFontShadow(uint8_t ubShadow) {
  ...
  FontShadow16 = rgb32_to_rgb16(FROMRGB(uiRed, uiGreen, uiBlue));
...
void SetFontBackground(uint8_t ubBackground) {
  ...
  FontBackground16 = rgb32_to_rgb16(FROMRGB(uiRed, uiGreen, uiBlue));
}
