...
BOOLEAN InitShopKeepersFace(uint8_t ubMercID) {
  ...
  SetAutoFaceActive(vsFB, NULL, giShopKeeperFaceIndex, SKI_FACE_X, SKI_FACE_Y);
...
BOOLEAN ExitShopKeeperInterface() {
  ...
  JSurface_Free(vsCornerWhereTacticalIsStillSeenImage);
...
BOOLEAN RenderShopKeeperInterface() {
  ...
  if (gfRenderScreenOnNextLoop) {
    ...
    BltVSurfaceRectToPoint(vsCornerWhereTacticalIsStillSeenImage, vsSaveBuffer, 0, 0, &SrcRect);
...
void RestoreTacticalBackGround() {
  ...
  BltVSurfaceRectToPoint(vsFB, vsCornerWhereTacticalIsStillSeenImage,
