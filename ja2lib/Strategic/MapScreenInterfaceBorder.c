...
BOOLEAN LoadMapBorderGraphics(void) {
  ...
  CHECKF(AddStandardVideoObject(&VObjectDesc, &guiMapBorder));
  ...
  /* corner was removed along with the Zoom feature
          ...
          CHECKF( AddStandardVideoObject( &VObjectDesc, &guiMapBorderCorner ) );
...
void RenderMapBorder(void) {
  ...
  */
  ...
  BltVideoObjectOld(vsSaveBufferID, hHandle, 0, MAP_BORDER_X, MAP_BORDER_Y);
...
void RenderMapBorderEtaPopUp(void) {
  ...
  */
  ...
  BltVideoObjectOld(vsIndexFB, hHandle, 0, MAP_BORDER_X + 215, 291);
...
void DisplayCurrentLevelMarker(void) {
  ...
  */
  ...
  BltVideoObjectOld(vsSaveBufferID, hHandle, 0, MAP_LEVEL_MARKER_X + 1,
