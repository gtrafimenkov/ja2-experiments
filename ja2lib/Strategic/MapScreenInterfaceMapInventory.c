...
BOOLEAN LoadInventoryPoolGraphic(void) {
  ...
  CHECKF(AddStandardVideoObject(&VObjectDesc, &guiMapInventoryPoolBackground));
...
void BlitInventoryPoolGraphic(void) {
  ...
  BltVideoObject(vsSB, hHandle, 0, INVEN_POOL_X, INVEN_POOL_Y, VO_BLT_SRCTRANSPARENCY, NULL);
