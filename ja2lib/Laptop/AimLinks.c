...
void RenderAimLinks() {
  ...
  BltVideoObjectOld(vsIndexFB, hPixHandle, 0, AIM_LINK_BOBBY_LINK_X, AIM_LINK_BOBBY_LINK_Y);

  GetVideoObject(&hPixHandle, guiFuneralLink);
  BltVideoObjectOld(vsIndexFB, hPixHandle, 0, AIM_LINK_FUNERAL_LINK_X, AIM_LINK_FUNERAL_LINK_Y);
  ...
  BltVideoObjectOld(vsIndexFB, hPixHandle, 0, AIM_LINK_INSURANCE_LINK_X, AIM_LINK_INSURANCE_LINK_Y);
