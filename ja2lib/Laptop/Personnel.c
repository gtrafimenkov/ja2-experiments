...
void RenderPersonnel(void) {
  ...
  BltVideoObject2(vsFB, hHandle, 0, LAPTOP_SCREEN_UL_X, LAPTOP_SCREEN_UL_Y + 22,
                  VO_BLT_SRCTRANSPARENCY, NULL);
...
BOOLEAN RenderPersonnelFace(int32_t iId, int32_t iSlot, BOOLEAN fDead, BOOLEAN fFired,
  ...
  BltVideoObject2(vsFB, hFaceHandle, 0, IMAGE_BOX_X + (iSlot * IMAGE_BOX_WIDTH), IMAGE_BOX_Y,
                  VO_BLT_SRCTRANSPARENCY, NULL);
...
BOOLEAN DisplayPicturesOfCurrentTeam(void) {
  ...
  for (iCounter = 0; iCounter < iTotalOnTeam; iCnt++) {
    if ((MercPtrs[iId + iCnt]->bActive == TRUE)) {
      ...
      BltVideoObject2(vsFB, hFaceHandle, 0,
                      (int16_t)(SMALL_PORTRAIT_START_X +
...
void RenderInventoryForCharacter(int32_t iId, int32_t iSlot) {
  ...
  BltVideoObject2(vsFB, hHandle, 0, (int16_t)(397), (int16_t)(200), VO_BLT_SRCTRANSPARENCY, NULL);
...
BOOLEAN RenderAtmPanel(void) {
  ...
  if (fShowAtmPanel) {
    ...
    // blit it
    GetVideoObject(&hHandle, uiBox);
    BltVideoObject2(vsFB, hHandle, 0, (int16_t)(ATM_UL_X), (int16_t)(ATM_UL_Y),
                    VO_BLT_SRCTRANSPARENCY, NULL);
    ...
    // blit it
    GetVideoObject(&hHandle, uiBox);
    BltVideoObject2(vsFB, hHandle, 1, (int16_t)(ATM_UL_X + 1), (int16_t)(ATM_UL_Y + 18),
                    VO_BLT_SRCTRANSPARENCY, NULL);
...
void RenderSliderBarForPersonnelInventory(void) {
  ...
  GetVideoObject(&hHandle, guiPersonnelInventory);
  BltVideoObject2(vsFB, hHandle, 5, (int16_t)(X_OF_PERSONNEL_SCROLL_REGION),
