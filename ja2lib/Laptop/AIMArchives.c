...
void SelectAlumniFaceRegionCallBack(struct MOUSE_REGION *pRegion, INT32 iReason, const struct MouseInput mouse);

// Done region
struct MOUSE_REGION gDoneRegion;
void SelectAlumniDoneRegionCallBack(struct MOUSE_REGION *pRegion, INT32 iReason, const struct MouseInput mouse);
