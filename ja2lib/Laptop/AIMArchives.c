...
void RenderAimArchives() {
  ...
  for (y = 0; y < ubNumRows; y++) {
    for (x = 0; x < AIM_ALUMNI_NUM_FACE_COLS; x++) {
      // Blt face to screen
      BltVideoObject(vsIndexFB, hFaceHandle, i, usPosX + 4, usPosY + 4);

      // Blt the alumni frame background
      BltVideoObject(vsIndexFB, hFrameHandle, 0, usPosX, usPosY);
...
void DisplayAlumniOldMercPopUp() {
  ...
  BltVideoObject(vsIndexFB, hAlumniPopUpHandle, 0, AIM_POPUP_X, usPosY);
  ...
  for (i = 0; i < ubNumLines; i++) {
    ShadowVideoSurfaceRect(vsIndexFB, AIM_POPUP_X + AIM_POPUP_SHADOW_GAP,
                           ...
                           AIM_POPUP_X + AIM_POPUP_WIDTH + AIM_POPUP_SHADOW_GAP,
                           usPosY + AIM_POPUP_SECTION_HEIGHT + AIM_POPUP_SHADOW_GAP - 1);
    BltVideoObject(vsIndexFB, hAlumniPopUpHandle, 1, AIM_POPUP_X, usPosY);
    usPosY += AIM_POPUP_SECTION_HEIGHT;
  }
  ...
  ShadowVideoSurfaceRect(vsIndexFB, AIM_POPUP_X + AIM_POPUP_SHADOW_GAP,
                         ...
                         AIM_POPUP_X + AIM_POPUP_WIDTH + AIM_POPUP_SHADOW_GAP,
                         usPosY + AIM_POPUP_SECTION_HEIGHT + AIM_POPUP_SHADOW_GAP - 1);
  BltVideoObject(vsIndexFB, hAlumniPopUpHandle, 2, AIM_POPUP_X, usPosY);
  BltVideoObject(vsIndexFB, hDoneHandle, 0, AIM_ALUMNI_DONE_X, usPosY - AIM_ALUMNI_DONE_HEIGHT);
  ...
  BltVideoObject(vsIndexFB, hFacePaneHandle, 0, AIM_ALUMNI_FACE_PANEL_X, AIM_ALUMNI_FACE_PANEL_Y);
  BltVideoObject(vsIndexFB, hFaceHandle, gubDrawOldMerc, AIM_ALUMNI_FACE_PANEL_X + 1,
