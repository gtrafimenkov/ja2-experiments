...
void RenderMercsFiles() {
  ...
  BltVideoObjectOld(vsIndexFB, hPixHandle, 0, MERC_FILES_PORTRAIT_BOX_X, MERC_FILES_PORTRAIT_BOX_Y);

  // Stats Box
  GetVideoObject(&hPixHandle, guiStatsBox);
  BltVideoObjectOld(vsIndexFB, hPixHandle, 0, MERC_FILES_STATS_BOX_X, MERC_FILES_STATS_BOX_Y);

  // bio box
  GetVideoObject(&hPixHandle, guiBioBox);
  BltVideoObjectOld(vsIndexFB, hPixHandle, 0, MERC_FILES_BIO_BOX_X + 1, MERC_FILES_BIO_BOX_Y);
...
BOOLEAN DisplayMercFace(uint8_t ubMercID) {
  ...
  BltVideoObjectOld(vsIndexFB, hPortraitHandle, 0, MERC_FILES_PORTRAIT_BOX_X,
  ...
  CHECKF(AddStandardVideoObject(&VObjectDesc, &guiMercFace));

  // Blt face to screen
  GetVideoObject(&hFaceHandle, guiMercFace);
  BltVideoObjectOld(vsIndexFB, hFaceHandle, 0, MERC_FACE_X, MERC_FACE_Y);
  ...
  if (IsMercDead(ubMercID)) {
    ...
    ShadowVideoSurfaceRect(vsIndexFB, MERC_FACE_X, MERC_FACE_Y, MERC_FACE_X + MERC_FACE_WIDTH,
