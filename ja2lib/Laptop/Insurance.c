...
void RenderInsurance() {
  ...
  BltVideoObjectOld(vsIndexFB, hPixHandle, 0, INSURANCE_BIG_TITLE_X, INSURANCE_BIG_TITLE_Y);
  ...
  BltVideoObjectOld(vsIndexFB, hPixHandle, 0, INSURANCE_SUBTITLE_X, INSURANCE_BULLET_TEXT_1_Y);
  ...
  BltVideoObjectOld(vsIndexFB, hPixHandle, 0, INSURANCE_SUBTITLE_X, INSURANCE_BULLET_TEXT_2_Y);
  ...
  BltVideoObjectOld(vsIndexFB, hPixHandle, 0, INSURANCE_SUBTITLE_X, INSURANCE_BULLET_TEXT_3_Y);
...
void DisplayInsuranceDefaults() {
  ...
  for (i = 0; i < 4; i++) {
    BltVideoObjectOld(vsIndexFB, hPixHandle, 0, INSURANCE_RED_BAR_X, usPosY);
  ...
  switch (guiCurrentLaptopMode) {
    case LAPTOP_MODE_INSURANCE:
      ...
      BltVideoObjectOld(vsIndexFB, hPixHandle, 0, INSURANCE_TOP_RED_BAR_X, usPosY);
  ...
  GetVideoObject(&hPixHandle, guiInsuranceBigRedLineImage);
  BltVideoObjectOld(vsIndexFB, hPixHandle, 0, INSURANCE_TOP_RED_BAR_X, INSURANCE_BOTTOM_RED_BAR_Y);

  // if it is not the first page, display the small title
  if (guiCurrentLaptopMode != LAPTOP_MODE_INSURANCE) {
    // display the small title bar
    GetVideoObject(&hPixHandle, guiInsuranceSmallTitleImage);
    BltVideoObjectOld(vsIndexFB, hPixHandle, 0, INSURANCE_SMALL_TITLE_X, INSURANCE_SMALL_TITLE_Y);
  }
}
