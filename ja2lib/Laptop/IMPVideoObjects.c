...
BOOLEAN LoadProfileBackGround(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiBACKGROUND));
...
BOOLEAN LoadIMPSymbol(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiIMPSYMBOL));
...
BOOLEAN LoadBeginIndent(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiBEGININDENT));
...
BOOLEAN LoadActivationIndent(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiACTIVATIONINDENT));
...
BOOLEAN LoadFrontPageIndent(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiFRONTPAGEINDENT));
...
BOOLEAN LoadAnalyse(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiANALYSE));
...
BOOLEAN LoadAttributeGraph(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiATTRIBUTEGRAPH));
...
BOOLEAN LoadAttributeGraphBar(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiATTRIBUTEGRAPHBAR));
...
BOOLEAN LoadFullNameIndent(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiFULLNAMEINDENT));
...
BOOLEAN LoadNickNameIndent(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiNICKNAMEINDENT));
...
BOOLEAN LoadNameIndent(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiNAMEINDENT));
...
BOOLEAN LoadGenderIndent(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiGENDERINDENT));
...
BOOLEAN LoadSmallFrame(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiSMALLFRAME));
...
BOOLEAN LoadSmallSilhouette(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiSMALLSILHOUETTE));
...
BOOLEAN LoadLargeSilhouette(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiLARGESILHOUETTE));
...
BOOLEAN LoadAttributeFrame(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiATTRIBUTEFRAME));
...
BOOLEAN LoadSliderBar(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiSLIDERBAR));
...
BOOLEAN LoadButton2Image(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiBUTTON2IMAGE));
...
BOOLEAN LoadButton4Image(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiBUTTON4IMAGE));
...
BOOLEAN LoadButton1Image(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiBUTTON1IMAGE));
...
BOOLEAN LoadPortraitFrame(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiPORTRAITFRAME));
...
BOOLEAN LoadMainIndentFrame(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiMAININDENT));
...
BOOLEAN LoadQtnLongIndentFrame(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiLONGINDENT));
...
BOOLEAN LoadQtnShortIndentFrame(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiSHORTINDENT));
...
BOOLEAN LoadQtnLongIndentHighFrame(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiLONGHINDENT));
...
BOOLEAN LoadQtnShortIndentHighFrame(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiSHORTHINDENT));
...
BOOLEAN LoadQtnIndentFrame(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiQINDENT));
...
BOOLEAN LoadAttrib1IndentFrame(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiA1INDENT));
...
BOOLEAN LoadAttrib2IndentFrame(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiA2INDENT));
...
BOOLEAN LoadAvgMercIndentFrame(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiAVGMERCINDENT));
...
BOOLEAN LoadAboutUsIndentFrame(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiABOUTUSINDENT));
...
BOOLEAN LoadQtnShort2IndentFrame(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiSHORT2INDENT));
...
BOOLEAN LoadQtnShort2IndentHighFrame(void) {
  ...
  CHECKF(AddVObjectAndSetTransparency(CreateVideoObject(&VObjectDesc), &guiSHORT2HINDENT));
