...
BOOLEAN EnterBobbyR() {
  ...
  if (!LaptopSaveInfo.fBobbyRSiteCanBeAccessed) {
    ...
    CHECKF(AddVObject(&VObjectDesc, &guiUnderConstructionImage));
...
BOOLEAN InitBobbyRWoodBackground() {
  ...
  CHECKF(AddVObject(&VObjectDesc, &guiWoodBackground));
