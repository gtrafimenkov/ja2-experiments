...
void RenderMercsAccount() {
  ...
  BltVideoObject(vsIndexFB, hPixHandle, 0, MERC_AC_ORDER_GRID_X, MERC_AC_ORDER_GRID_Y);

  // Merc Order Grid
  GetVideoObject(&hPixHandle, guiAccountNumberGrid);
  BltVideoObject(vsIndexFB, hPixHandle, 0, MERC_AC_ACCOUNT_NUMBER_X, MERC_AC_ACCOUNT_NUMBER_Y);
