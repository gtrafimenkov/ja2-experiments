...
BOOLEAN DisplayBobbyRBrTitle() {
  ...
  BltVideoObject(vsFB, hPixHandle, 0, BOBBYR_BRTITLE_X, BOBBYR_BRTITLE_Y, VO_BLT_SRCTRANSPARENCY,
                 NULL);
...
BOOLEAN DisplayBigItemImage(uint16_t usIndex, uint16_t PosY) {
  ...
  BltVideoObject(vsFB, hPixHandle, 0, sCenX, sCenY, VO_BLT_SRCTRANSPARENCY, NULL);
